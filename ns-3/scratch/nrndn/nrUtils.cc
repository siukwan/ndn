...
nrUtils::MessageArrivalMap nrUtils::msgArrivalCounter;//接收到信息的车占所有车的比例
nrUtils::ForwardCounterMap nrUtils::forwardCounter;//所有信息转发次数
nrUtils::ForwardCounterMap nrUtils::interestForwardCounter;//兴趣转发次数
nrUtils::TransmissionDelayMap nrUtils::TransmissionDelayRecord;//传输延时记录
